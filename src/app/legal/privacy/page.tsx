...
const sections = [
  {
    title: "1. 基本方針",
    body: "犬山総合高等学校文化祭実行委員会（以下「当委員会」）は、ISF文化祭アプリ（以下「本アプリ」）の利用者のプライバシーを尊重し、個人情報の保護に努めます。本ポリシーは、本アプリにおける情報の収集・利用・管理の方針を定めます。",
  },
  {
    title: "2. 収集する情報",
  ...
  },
  {
    ...
    body: "本アプリはVercel（米Vercel Inc.）のホスティングを利用しており、アクセスログ（IPアドレス・ブラウザ情報等）がVercelのサーバーに記録される場合があります。またFirebase（Google LLC）を利用しており、データ通信がGoogleのサーバーを経由します。これらの情報の取り扱いについては各社のプライバシーポリシーに従います。",
  },
  {
    title: "6. 未成年者の利用",
    body: "本アプリは犬山総合高等学校の生徒（未成年者を含む）も利用します。収集する情報は上記「2. 収集する情報」に限定しており、個人を特定する情報（氏名・住所・電話番号等）は一切収集しません。",
  },
  {
    title: "7. 情報の保存期間",
    body: "デバイス内に保存された情報は、利用者がCookieをリセットするか、ブラウザのデータを消去するまで保持されます。当委員会のサーバーには個人情報を保存していないため、当委員会側での削除要求は対象外となります。",
  },
  {
    title: "8. ポリシーの変更",
  ...
  {
    title: "9. お問い合わせ",
    body: "本ポリシーに関するお問い合わせは、文化祭実行委員会を通じて技術担当までご連絡ください。",
  },
];
