...
export default function HeaderGuideBar() {
  ...
  if (mode === "notification") {
    return (
      <div className="flex items-center gap-3 border-b border-yellow-200 dark:border-yellow-800 bg-yellow-50 dark:bg-yellow-950 px-4 py-2">
        <svg className="shrink-0 text-yellow-500 dark:text-yellow-400" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
          <path d="M18 8A6 6 0 006 8c0 7-3 9-3 9h18s-3-2-3-9" />
          <path d="M13.73 21a2 2 0 01-3.46 0" />
        </svg>
        <p className="flex-1 min-w-0 text-xs text-yellow-800 dark:text-yellow-300">
        ...
        <button onClick={() => dismiss("notification")} aria-label="閉じる" className="shrink-0 text-yellow-600 dark:text-yellow-400">
