...
- Feat: SVGマップ（ZoomableMap）を復元・混雑一覧の並び順を閑散→混雑の昇順に修正([#98](https://github.com/sho29saka31/inuso-viewer/pull/98))
- Feat: フォントを Google Fonts CDN から `@fontsource/m-plus-rounded-1c` に self-hosting 移行([#97](https://github.com/sho29saka31/inuso-viewer/pull/97))
